...
class ReportInventarisRumijaController extends Controller
{
    ...
    public function download(Request $request)
    {
        try {
            ...
            $inventaris = RumijaInventarisasi::whereIn('id_ruas_jalan', $ruas_jalan_id)->whereYear('created_at', date('Y'))->get();

            if (count($inventaris) == 0) throw new Exception("Data tidak tersedia");
