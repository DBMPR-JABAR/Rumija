    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-block">
                ...
                <a href="{{ route('rumija.inventarisasi.kategori.create') }}" class="mb-3 btn btn-mat btn-primary">Tambah</a>
...
<script>
    ...
    $("#delModal").on("show.bs.modal", function (event) {
        ...
        console.log(id);
        const url = `{{ url('admin/inventarisasi/kategori/delete') }}/` + id;
        console.log(url);
        const modal = $(this);
